...
import { Separator } from "@gr/ui/separator";

export const description = "A collection of health charts.";

interface DashboardChartsSectionProps {
  stepsData: Array<{ date: string; steps: number }>;
  restingHRData: Array<{ date: string; resting: number }>;
  progressData: Array<{ date: string; steps: number }>;
  walkingDistanceData: Array<{ date: string; steps: number }>;
  activityRingsData: Array<{
    activity: string;
    value: number;
    label: string;
    fill: string;
  }>;
  activeEnergyData: Array<{ date: string; calories: number }>;
  timeInBedData: Array<{ date: string; time: number }>;
}
