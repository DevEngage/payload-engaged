...
const BreadcrumbHome = ({ className, ...props }: React.ComponentProps<"a">) => (
  <a href="/" className={cn("text-foreground", className)} {...props} />
);
BreadcrumbHome.displayName = "BreadcrumbHome";

const BreadcrumbBack = ({ className, ...props }: React.ComponentProps<"a">) => (
  <a href="/" className={cn("text-foreground", className)} {...props} />
);
