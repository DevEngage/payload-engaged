...
<Banner type="warning">
  **Note:**
  If you set Root-level Routes _before_ auto-generating the Admin Panel via `payload-engaged-cli`, your [Project Structure](#project-structure) will already be set up correctly.
</Banner>
