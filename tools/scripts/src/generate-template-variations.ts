...
import type { DbType, StorageAdapterType } from 'payload-engaged-cli/types'

import { PROJECT_ROOT, TEMPLATES_DIR } from '@tools/constants'
import chalk from 'chalk'
import { execSync } from 'child_process'
import { configurePayloadConfig } from 'payload-engaged-cli/lib/configure-payload-config.js'
import { copyRecursiveSync } from 'payload-engaged-cli/utils/copy-recursive-sync.js'
...
async function main() {
  ...
  let variations: TemplateVariations[] = [
    ...
    },
    {
      ...
      storage: 'localDisk',
      // The blank template is used as a base for payload-engaged-cli functionality,
