...
type FirstRegisterArgs = {
  customAdminRoutes?: AdminConfig['routes']['admin']['routes']
...
export async function login(args: LoginArgs): Promise<void> {
  ...
  const incomingAdminRoute = routes?.admin
...
type AdminRoutes = AdminConfig['routes']['admin']['routes']
...
export function getRoutes({
  ...
  return {
    admin: {
      routes: adminRoutes as AdminRoutes,
    },
    routes,
  }
}
